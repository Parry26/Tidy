...
Codebook was generated on 'r as.character(Sys.time())'. See also Readme.md for details of how this project was produced and the functioning or run_analysis.R. 

The units of interest in this study are identified according according to the following variables: 
